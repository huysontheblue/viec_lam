...
<body style="margin-top: 200px;" class="hold-transition login-page">
  <div class="login-box">
    <div class="login-box-body" style="min-height: 296px;width: 400px; border-radius: 10px;">
      <h1 class="login-box-msg">Đăng nhập hệ thống</h1>
      <hr/>
      <p>
        <?php check_message(); ?>
      </p>
...
<?php 
  if(isset($_POST['btnLogin'])){
   ...
   if ($email == '' OR $upass == '') {
    ...
    if ($res==true) { 
      message("Bạn đăng nhập bằng ".$_SESSION['ROLE'].".","success");
