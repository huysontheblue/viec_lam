...
<head>
  <meta charset="UTF-8">
  <title>Việc làm / Trang quản trị</title>
  ...
  <div class="wrapper">
    <header class="main-header">
      ...
      <a href="<?php echo web_root;?>/admin/" class="logo">
        <!-- mini logo for sidebar mini 50x50 px -->
        <span class="logo-mini"><b>Đăng tin việc làm</b></span>
        <!-- logo for regular state and mobile devices -->
        <span class="logo-lg"><b>Đăng tin việc làm</b></span>
      </a>
        ...
        <div class="navbar-custom-menu">
          ...
          <li class="dropdown user user-menu" style="padding-right: 15px;"  >
            ...
            <ul class="dropdown-menu">
              <!-- User image -->
              <li style="height: 116px;" class="user-header"> 
              ...
              <li class="user-footer">
                <div class="pull-left">
                  <a href="<?php echo web_root.'admin/user/index.php?view=view&id='.$_SESSION['ADMIN_USERID'] ;?>" class="btn btn-default btn-flat">Chi tiết</a>
                </div>
    ...
    <div class="modal-content">
      ...
      <form action="<?php echo web_root; ?>admin/user/controller.php?action=photos" enctype="multipart/form-data" method="post">
        ...
        <div class="modal-footer">
          <button class="btn btn-default" data-dismiss="modal" type="button">Đóng</button> <button class="btn btn-primary" name="savephoto" type="submit">Tải ảnh lên</button>
        </div>
      </form>
    </div>
  </div>
      ...
      <ul class="sidebar-menu"> 
        ...
        <li class="<?php echo (currentpage() == 'vacancy') ? "active" : false;?>" >
          <a href="<?php echo web_root ;?>admin/vacancy/">
            <i class="fa fa-suitcase"></i> <span>Vị trí tuyển dụng</span> 
          </a>
        </li>
