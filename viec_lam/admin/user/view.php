    ...
    <div class="row">
      <div class="col-md-4">
         <a  data-target="#myModal" data-toggle="modal" href="" title="Bấm vào đây để thay đổi hình ảnh." >
            <img alt="" style="width:320px; height:300px;>"title="" class="img-circle img-thumbnail isTooltip" src="<?php echo web_root.'admin/user/'. $singleuser->PICLOCATION;?>" data-original-title="Usuario"> 
         </a>  
      </div>
      <div class="col-md-6">
        <h1><strong>Thông tin người quản trị</strong></h1><br>
              ...
              <div class="col-md-8">
                ...
                <div class="col-md-8">
                  <select class="form-control input-sm" name="U_ROLE" id="U_ROLE">
                    <option value="Quản trị viên"  <?php echo ($singleuser->ROLE=='Quản trị viên') ? 'selected="true"': '' ; ?>>Quản trị viên</option>
