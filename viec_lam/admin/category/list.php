...
<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header">Danh sách các công việc<a href="index.php?view=add" class="btn btn-primary btn-xs"> <i class="fa fa-plus-circle fw-fa"></i> Thêm công việc</a>  </h1>
    </div>
</div>
